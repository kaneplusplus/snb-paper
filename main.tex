...
%\font\fiverm=cmr5                     % Font definition for PicTex
%\input{prepic.tex}                    % Input three PicTeX files
%\input{pictex.tex}
%\input{postpic.tex}
...
%  These commands allow exercises listed as \item[]'s to be listed in
%  the .aux file and referenced in the text.
