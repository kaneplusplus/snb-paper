...
Tab.~\ref{tab:snb} summarizes the distribution and 
...
\section{Connection Between $S$ and the Binomial Tail Probability}
...
This result is visualized in Fig.~\ref{fig:snb_bin_compare} for the case
