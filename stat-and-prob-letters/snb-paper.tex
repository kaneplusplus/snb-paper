...
distribution with a Beta($\alpha$, $\beta$) prior is
...
\begin{figure}[t!]
\centering
\subfloat[The expected sample size.]{\includegraphics[width=0.5\textwidth]{bayesian-sample-expectation.pdf}}
\hfill
\subfloat[The variance of the sample size.]{\includegraphics[width=0.5\textwidth]{bayesian-sample-variance.pdf}}
\caption{
The expected size and variance of the compound SNB varying the uncertainty 
